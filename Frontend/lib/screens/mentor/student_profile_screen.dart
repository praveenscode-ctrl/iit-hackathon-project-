          ...
          child: ListView(
            ...
            children: [
              ...
              Row(children: [
                Expanded(
                    child:
                        _tile('Assigned', '${a.totalAssigned}', Colors.blue)),
                const SizedBox(width: 8),
                Expanded(
                    child: _tile('Done', '${a.totalSubmitted}', Colors.green)),
                const SizedBox(width: 8),
                Expanded(
                    child: _tile('Missed', '${a.totalMissed}', Colors.red)),
              ]),
              const SizedBox(height: 8),
              Row(children: [
